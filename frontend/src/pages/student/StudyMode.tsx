    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center p-4 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          You have no cards due for review in this set right now.
        </p>
      ...
      <div className="h-screen flex flex-col items-center justify-center p-4 text-center bg-green-50">
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div className="text-center">
            ...
            <div className="text-sm text-green-800 uppercase font-bold tracking-wide">
              Remembered
            </div>
          </div>
          <div className="text-center">
            ...
            <div className="text-sm text-orange-800 uppercase font-bold tracking-wide">
              Learning
            </div>
          </div>
        </div>
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-100 overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 perspective-1000">
        <div
          className="relative w-full max-w-xl aspect-[3/4] md:aspect-[3/2] cursor-pointer group"
          onClick={!currentCard.options ? handleFlip : undefined}
        >
          <motion.div
          ...
          >
            {/* Front */}
            <Card className="absolute inset-0 backface-hidden flex flex-col items-center justify-center p-8 text-center shadow-xl border-2 border-slate-200 overflow-y-auto">
              <div className="text-xs uppercase font-bold text-slate-400 mb-4 tracking-widest">
                Question
              </div>
              <div className="text-2xl md:text-3xl font-medium text-slate-800 mb-8">
                ...
                <div className="w-full grid gap-3">
                  {currentCard.options.map((option: string, idx: number) => (
                    <Button
                      key={idx}
                      variant="outline"
                      className="w-full text-left justify-start h-auto py-3 px-4 whitespace-normal text-base hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 relative"
                      onClick={(e) => {
                        e.stopPropagation();
                        if (option === currentCard.back_content) {
                          setFeedback(null);
                          handleFlip();
                        } else {
              ...
              {feedback && (
                <div className="mt-4 text-red-500 font-medium animate-pulse">
                  {feedback}
                </div>
              )}
            </Card>
            ...
            >
              <div className="text-xs uppercase font-bold text-blue-400 mb-4 tracking-widest">
                Answer
              </div>
