...
const liveEmail = process.env.PASSWORD_RESET_LIVE_EMAIL
const oldPassword = process.env.PASSWORD_RESET_LIVE_OLD_PASSWORD
const newPassword = process.env.PASSWORD_RESET_LIVE_NEW_PASSWORD
const mailpitUrl = process.env.PASSWORD_RESET_LIVE_MAILPIT_URL
...
test('live request -> captured email -> reset page -> password and token semantics', async ({ page, request }) => {
  test.skip(
    ...
    'Set PASSWORD_RESET_LIVE_EMAIL, PASSWORD_RESET_LIVE_OLD_PASSWORD, PASSWORD_RESET_LIVE_NEW_PASSWORD, and PASSWORD_RESET_LIVE_MAILPIT_URL',
  )
