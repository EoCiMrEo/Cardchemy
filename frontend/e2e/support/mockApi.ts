...
export const fixtures = {
  ...
  generationJob: {
    ...
    provider_rate_limit_wait_milliseconds: 12_500,
    cached_input_tokens: 8_192,
    provider_request_counts_by_stage: { planning: 1, card_generation: 2 },
    actual_input_tokens: 16_000,
    actual_output_tokens: 1_500,
    estimated_cost_microusd: 2_000,
    actual_cost_microusd: 1_700,
    usage_estimated: false,
    accepted_card_count: 2,
    rejected_card_count: 1,
    limit_reason_code: null,
    limit_reason_message: null,
    source_pdf_name: 'cell-biology.pdf',
    attempt_count: 1,
    max_attempts: 3,
    error_code: null,
    error_message: null,
    cancellation_requested_at: null,
    source_retry_expires_at: null,
    created_at: '2026-09-14T00:00:00Z',
    started_at: '2026-09-14T00:00:01Z',
    completed_at: '2026-09-14T00:00:10Z',
