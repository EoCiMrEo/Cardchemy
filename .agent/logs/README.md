...
| Date | Log | Summary |
|---|---|---|
| 2026-09-17 | `2026-09-17-subject-rag-plan-review.md` | Approved Subject-scoped RAG V1 plan: independent capture, versioned citations, DB-enforced Subject integrity, isolated workers/budgets, pgvector rollout and early privacy/retrieval gates; documentation only. |
