...
| Date | Log | Summary |
|---|---|---|
| 2026-09-18 | [Final runtime-image PR reconciliation](2026-09-18/2026-09-18-final-runtime-image-pr-reconciliation.md) | Preserves PR #24's Dependabot history while retaining the tested, supported runtime image pins already on protected main. |
