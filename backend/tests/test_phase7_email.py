"""Phase 7 transactional-email unit and SQLite worker proofs."""
...
async def test_invitation_event_is_bound_to_recipient_and_domain_record(db):
    instructor = User(
        id=uuid4(),
        email="phase7-instructor@example.com",
